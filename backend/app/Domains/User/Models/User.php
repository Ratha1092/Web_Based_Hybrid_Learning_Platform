...
use App\Domains\User\Models\InstructorProfile;
use App\Domains\User\Models\StudentProfile;
...
{   
    ...
    {
        return $this->hasMany(\App\Models\EmailVerificationToken::class);
    }
    ...
    {
        return $this->hasMany(\App\Models\PasswordResetToken::class);
    }
    ...
    {
        return $this->hasMany(\App\Models\OAuthAccount::class);
    }
