...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .status-draft { background: rgba(244,185,74,.15); color: var(--gold); }
        .status-pending { background: rgba(244,185,74,.15); color: var(--gold); }
    ...
    <div class="main">
        <div class="topbar">
            <div>
                ...
                <h1 class="text-2xl font-bold serif">My Courses</h1>
                <p class="text-sm text-gray-400 mt-1">Manage and track your course offerings</p>
            </div>
            <div class="topbar-actions">
                <a href="{{ route('instructor.courses.create') }}" class="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg font-medium transition-colors">
                    + Create Course
                </a>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                ...
                <div class="course-card">
                    <div class="flex justify-between items-start mb-3">
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-400 mb-2">{{ Str::limit($course->short_description, 80) }}</p>
                            <div class="flex items-center gap-4 text-xs text-gray-500">
                                <span>{{ $course->enrollments->count() }} students</span>
                                <span>{{ $course->reviews->avg('rating') ? number_format($course->reviews->avg('rating'), 1) : 'No' }} reviews</span>
                            </div>
                        </div>
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <div class="flex gap-2">
                            <button class="icon-btn" title="Edit Course">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/>
                                    <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/>
                                </svg>
                            </button>
                            <button class="icon-btn" title="View Analytics">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            @empty
                <div class="col-span-full">
                    <div class="course-card text-center py-12">
                        ...
                        <a href="{{ route('instructor.courses.create') }}" class="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg font-medium transition-colors inline-block">
